...
@section('content')
    <div class="flex flex-row min-h-screen">
        ...
        <div class="flex-1 p-10 bg-gray-50">
            <h1 class="text-center text-2xl font-bold my-6">Hasil Penilaian</h1>
            <div class="overflow-x-auto">
                <table class="table-auto w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td colspan="3" class="border border-gray-300 px-4 py-2 text-center">Tidak ada data tersedia.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
